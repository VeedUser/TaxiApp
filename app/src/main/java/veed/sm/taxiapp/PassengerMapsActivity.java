...
import veed.sm.taxiapp.databinding.ActivityDriverMapsBinding;
import veed.sm.taxiapp.databinding.ActivityPassengerMapsBinding;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookTaxiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bookTaxiBtn.setText("Getting your taxi...");
    ...
    private void getNearestDriverLocation() {
        bookTaxiBtn.setText("Getting your driver location...");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    LatLng driverLatLng = new LatLng(latitude,longitude);
                     ...
                     bookTaxiBtn.setText("Distance to driver: " +
                             distanceToDriver);
    ...
    private void signOutPassenger() {
        ...
        Intent intent = new Intent(PassengerMapsActivity.this, ChooseModActivity.class);
